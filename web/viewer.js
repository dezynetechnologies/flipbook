...
var PDFView = {
  ...
  get supportsFullscreen() {
    ...
    support = false;//we override foe disabling ppt mode
...
//#endif
  ...
  getVisiblePages: function pdfViewGetVisiblePages() {
    ...
    var first = visiblePages[0];
    var last = visiblePages[visiblePages.length - 1];    
    return {first: first, last: last, views: visiblePages, percent : 100 };
    /*
